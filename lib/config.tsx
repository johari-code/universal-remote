...
export const siteConfig = {
  ...
  featureHighlight: [
    {
      title: "38kHz IR Learning Mode",
      description:
        "Capture any remote's NEC protocol signals. One-tap learning stores hex codes directly to Supabase.",
      imageSrc: "/Device-2.png",
      direction: "rtl" as const,
    },
    {
      title: "MQTT Real-Time Control",
      description:
        "Sub-second response over HiveMQ Cloud. Secure WebSocket connection bridges your phone to ESP32 anywhere.",
      imageSrc: "/Device-3.png",
      direction: "ltr" as const,
    },
    {
      title: "Grid-Based Layout Designer",
      description:
        "3x11 grid system for precise button placement. Drag components, build your perfect remote interface.",
      imageSrc: "/Device-2.png", // Reusing temporarily
      direction: "rtl" as const,
    },
    {
      title: "ESP32-S3 IR Transceiver",
      description:
        "Hardware bridge with WS2812 feedback. Persistent MQTT connection with automatic reconnection handling.",
      imageSrc: "/handmockup.png", // Reusing temporarily
      direction: "ltr" as const,
    },
  ],
  bento: [
