...
function Feature({
  ...
  return (
    <motion.div
    className={cn(
      "flex flex-col items-center justify-between pb-10 transition-all duration-500 ease-out w-full",
      isLTR ? "lg:flex-row" : "lg:flex-row-reverse"
    )}
    >
    <motion.div
    className={cn(
      "w-full lg:w-1/2 mb-10 lg:mb-0 flex justify-center",
      isLTR ? "lg:justify-end lg:pr-12" : "lg:justify-start lg:pl-12"
    )}
    initial="hidden"
    ...
    <motion.p className="text-xl md:text-2xl text-zinc-400" variants={itemVariants}>
    {description}
    </motion.p>
